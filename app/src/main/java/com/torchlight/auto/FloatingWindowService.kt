...
class FloatingWindowService : Service() {
    ...
    private val updateReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            if (intent.action == "UPDATE_FLOATING") updateDisplay()
        }
    }
    override fun onCreate() {
        ...
        updateDisplay()
        registerReceiver(updateReceiver, IntentFilter("UPDATE_FLOATING"))
    }
    ...
    fun updateDisplay() {
        ...
        lastItemText.text = if (lastEntry != null) "${lastEntry!!.item} x${lastEntry!!.quantity} +${lastEntry!!.fireValue}火" else "暂无掉落"
    }
